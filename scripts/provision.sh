...
debconf-set-selections <<< "mysql-server mysql-server/root_password password unicorn"
debconf-set-selections <<< "mysql-server mysql-server/root_password_again password unicorn"
...
mysqladmin -u root -punicorn create vagrant
