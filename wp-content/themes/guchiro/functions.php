...
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.net/shop/skt-medical/');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-medical-documentation/');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/skt-medical/');
define('SKT_THEME_FEATURED_SET_VIDEO_URL','https://www.youtube.com/watch?v=310YGYtGLIM');

function healing_touch_credit(){
		return _ex( 'Design by <a href="'.esc_url(SKT_URL).'">SKT Themes</a>', 'healing-touch' );
}
