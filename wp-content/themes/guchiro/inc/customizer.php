...
function healing_touch_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
        'logo_sec',
        array(
            'title' => __('Logo (PRO Version)', 'healing-touch'),
            'priority' => 1,
 			'description' => sprintf( __( 'Logo (PRO Version)<br /> %s.', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'healing-touch' )
						)
					),					
        )
    );  
    $wp_customize->add_setting('healing_touch_options[logo-info]', array(
			'sanitize_callback' => 'sanitize_text_field',
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new healing_touch_Info( $wp_customize, 'logo_section', array(
        'section' => 'logo_sec',
        'settings' => 'healing_touch_options[logo-info]',
        'priority' => null
        ) )
    );
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control($wp_customize,'color_scheme',array(
			'label' => __('Color Scheme','healing-touch'),
 			'description' => sprintf( __( 'More color options in<br /> %s.', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'healing-touch' )
						)
					),	
			'section' => 'colors',
	...
	$wp_customize->add_section('footer_text',array(
			'title'	=> __('Footer Text','healing-touch'),
			'priority'	=> null,
			'description'	=> __('Add footer copyright text','healing-touch')
	));
	
	$wp_customize->add_setting('healing_touch_options[credit-info]', array(
			'sanitize_callback' => 'sanitize_text_field',
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new healing_touch_Info( $wp_customize, 'cred_section', array(
        'section' => 'footer_text',
		'label'	=> __('To remove credit &amp; copyright text upgrade to PRO version','healing-touch'),
        'settings' => 'healing_touch_options[credit-info]',
        ) )
    );
	
	$wp_customize->add_section('slider_section',array(
		'title'	=> __('Slider Settings','healing-touch'),
		'description' => sprintf( __( 'Slider Image Dimensions ( 1400 X 717 )<br/> Select Featured Image for these pages <br /> How to set featured image <a href="%1$s" target="_blank">Click Here ?</a><br/><br/> More slider settings available in <a href="%2$s" target="_blank">PRO Version</a>', 'healing-touch' ),
...
// Home Boxes 	
	...
	$wp_customize->add_section('social_sec',array(
			'title'	=> __('Social Settings','healing-touch'),
	 		'description' => sprintf( __( 'Add social icons link here More icon available in<br /> %s.', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'healing-touch' )
						)
					),			
			'priority'		=> null
	));
	...
	$wp_customize->add_section(
        'theme_layout_sec',
        array(
            'title' => __('Layout Settings (PRO Version)', 'healing-touch'),
            'priority' => null,
 		    'description' => sprintf( __( 'Layout Settings available in', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'healing-touch' ) )
			),			
        )
    );  
    $wp_customize->add_setting('healing_touch_options[layout-info]', array(
			'sanitize_callback' => 'sanitize_text_field',
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new healing_touch_Info( $wp_customize, 'layout_section', array(
        'section' => 'theme_layout_sec',
        'settings' => 'healing_touch_options[layout-info]',
        'priority' => null
        ) )
    );
	...
	$wp_customize->add_section(
        'theme_font_sec',
        array(
            'title' => __('Fonts Settings (PRO Version)', 'healing-touch'),
            'priority' => null,
	 		'description' => sprintf( __( 'Font Settings available in<br /> %s.', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'healing-touch' )
						)
					),						
        )
    );  
    $wp_customize->add_setting('healing_touch_options[font-info]', array(
			'sanitize_callback' => 'sanitize_text_field',
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new healing_touch_Info( $wp_customize, 'font_section', array(
        'section' => 'theme_font_sec',
        'settings' => 'healing_touch_options[font-info]',
        'priority' => null
        ) )
    );
    ...
    $wp_customize->add_section(
        'theme_doc_sec',
        array(
            'title' => __('Documentation &amp; Support', 'healing-touch'),
            'priority' => null,
	 		'description' => sprintf( __( 'For documentation and support check this link :<br /> %s.', 'healing-touch' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_THEME_DOC.'"' ), __( 'Healing Touch Documentation', 'healing-touch' )
						)
					),
        )
    );  
    $wp_customize->add_setting('healing_touch_options[info]', array(
			'sanitize_callback' => 'sanitize_text_field',
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new healing_touch_Info( $wp_customize, 'doc_section', array(
        'section' => 'theme_doc_sec',
        'settings' => 'healing_touch_options[info]',
        'priority' => 10
        ) )
    );
